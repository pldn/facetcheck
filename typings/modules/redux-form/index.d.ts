...
declare module "~redux-form/lib/reduxForm" {
  import { Component, ReactElement, SyntheticEvent, ReactEventHandler } from "react";
...
declare module "~redux-form/lib/Field" {
  import { Component, ReactElement, DragEventHandler, FocusEventHandler, FormEventHandler } from "react";
  import { Dispatch } from "redux";
 ...
 */
  export class Field<P> extends Component<P, {}> implements GenericField<P, any> {
    /**
     * true if the current value is different from the initialized value,
     * false otherwise.
     */
...
declare module "~redux-form/index" {
  ...
  export type FormErrors<FormData extends DataShape> = { [P in keyof FormData]?: React.ReactElement<any> | string } & {
    _error?: string;
  };
