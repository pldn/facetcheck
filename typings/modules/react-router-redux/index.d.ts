...
declare module "~react-router-redux~history" {
  namespace otherHistory {
    ...
    export function useBeforeUnload<TArguments, TResult extends History>(
      createHistory: CreateHistory<TArguments, TResult>
    ): CreateHistory<TArguments, TResult & BeforeUnload>;

    export function useQueries<TArguments, TResult extends History>(
      createHistory: CreateHistory<TArguments, TResult>
    ): CreateHistory<TArguments & QueryOptions, TResult>;

    export function useBasename<TArguments, TResult extends History>(
      createHistory: CreateHistory<TArguments, TResult>
    ): CreateHistory<TArguments & BasenameOptions, TResult>;
  }
...
declare module "~react-router-redux~redux" {
  namespace redux {
    ...
    export function bindActionCreators<TActionCreator extends Function | { [key: string]: Function }>(
      actionCreators: TActionCreator,
      dispatch: IDispatch
    ): TActionCreator;
...
declare module "react-router-redux" {
  ...
  namespace reactRouterRedux {
     ...
     */
    export function syncHistoryWithStore<TState>(
      history: History,
      store: IStore<TState>,
      options?: ISyncHistoryOptions<TState>
    ): History;
