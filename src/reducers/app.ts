...
export function isCollapsedSm(state:GlobalState) {
  return !state.routing.locationBeforeTransitions || !state.routing.locationBeforeTransitions.state || !!state.routing.locationBeforeTransitions.state.dsPanelCollapsedSm
}
