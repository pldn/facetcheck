...
//had to modify the typescript definition of the connect function to return ClassDecorator.
      ...
      <div className={getClassName(enabledStyles)}>
        <Navbar fixedTop fluid bsStyle={null} className={styles.navbar}>
          <Navbar.Header>
            ...
            <HamburgerBtn onClick={this.props.toggleDsPanelCollapseLg} className={'visible-xs'} title={"Toggle Navigation"}/>
