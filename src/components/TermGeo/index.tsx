...
class TermGeo extends React.PureComponent<TermGeo.Props,TermGeo.State> {
  ...
  **/
  loadLeaflet(wktString:string) {
    ...
    var k = new L.Proj.CRS("EPSG:28992", "+proj=sterea +lat_0=52.15616055555555 +lon_0=5.38763888888889 +k=0.9999079 +x_0=155000 +y_0=463000 +ellps=bessel +units=m +towgs84=565.2369,50.0087,465.658,-0.406857330322398,0.350732676542563,-1.8703473836068,4.0812 +no_defs", {
    ...
    var zoomToEl = function(e:any){map.setView(e.latlng, 15)}
  ...
  getModal(wktString:string) {
    return <Bs.Modal className={styles.modal} bsSize="large" onEntered={() => {this.loadLeaflet(wktString)}}backdrop show={this.state.showModal} onHide={this.close.bind(this)}>
      <Bs.Modal.Body>
  ...
  render() {
    ...
    return <div className={getClassName(style)}>
        <Bs.Button className="btn-info-inverse" bsSize="small" onClick={() => {this.open()}}><i className="fa fa-map"/>&nbsp;&nbsp; Show map</Bs.Button>
