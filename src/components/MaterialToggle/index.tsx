...
class MaterialToggle extends React.PureComponent<
  MaterialToggle.Props & ReduxForm.WrappedFieldProps<any>,
  MaterialToggle.State
> {
  ...
  render() {
    ...
    var warning: string;
    if (this.props.custom && this.props.custom.warnOnChanged && !pristine)
      warning = this.props.custom.warnOnChanged(value);
    return (
      <div>
        <Toggle
          {...this.adjustOwnProps()}
