...
class MaterialTextField extends React.PureComponent<
  MaterialTextField.Props & ReduxForm.WrappedFieldProps<any>,
  MaterialTextField.State
> {
  field: any;
  fieldWrapper: any;
  ...
  getLeftIcon(extraStyle: React.CSSProperties = {}) {
    ...
    if (this.props.custom && this.props.custom.leftIcon)
      return (
        <i style={this.getBaseIconStyle(_.assign(style, extraStyle))} className={"fa " + this.props.custom.leftIcon} />
      );
    return null;
  }
