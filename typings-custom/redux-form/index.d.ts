 ...
 */
 //laurens: removed extending component. Otherwise whenever we include a decorated form,
 //we'd need to specify key's such as `context` from the component props
// interface Form<FormData extends DataShape, P, S> extends Component<P, any> {
interface Form<FormData extends DataShape, P, S>  {
  /**
...
interface Selector<State> {
  (state: State, ...field: string[]): Object | string
}
